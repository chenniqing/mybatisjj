...
- 文档地址：<https://product.javaex.cn/product/mybatisjj/>
...
`mybatisjj` 的增强方式没有走“重封装”路线，而是尽量保留这类体验：
...
**如果需要一个轻量、直接、低接入成本的 MyBatis 增强方案，`mybatisjj` 值得先跑一遍。**
